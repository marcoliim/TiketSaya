        ...
        btn_continue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (xnama_lengkap.isEmpty()){
                    Toast.makeText(getApplicationContext(), "Please fill Nama Lengkap!", Toast.LENGTH_SHORT).show();
                    btn_continue.setEnabled(true);
                    btn_continue.setText("CONTINUE");
                }
                else {
                    if (xbio.isEmpty()){
                        Toast.makeText(getApplicationContext(), "Please fill Bio!", Toast.LENGTH_SHORT).show();
                        btn_continue.setEnabled(true);
                        btn_continue.setText("CONTINUE");
                    }
                    else {
